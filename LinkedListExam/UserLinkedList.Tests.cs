...
namespace LinkedList.Tests
{
    ...
    public class LinkedList_Tests
    {
        ...
        public void TestSortedAdd()
        {
            ...
            Assert.AreEqual(henrik, list.RemoveFirst());
            Assert.AreEqual(klaus, list.RemoveFirst());
            Assert.AreEqual(kristian, list.RemoveFirst());
            Assert.AreEqual(mads, list.RemoveFirst());
            Assert.AreEqual(torill, list.RemoveFirst());

        }

        [TestMethod]
        public void TestSortedAdd2()
        {
            User kristian = new User("Kristian", 1);
            User mads = new User("Mads", 2);
            User torill = new User("Torill", 3);
            ...
            UserLinkedList list = new UserLinkedList();
            list.InsertSorted(kristian);
            list.InsertSorted(mads);
            list.InsertSorted(torill);
            list.InsertSorted(henrik);
            list.InsertSorted(klaus);
